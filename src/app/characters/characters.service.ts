...
@Injectable({
  ...
  export class CharacterService {
    ...
    getCharactersFromServer(pageIdx: number, pageLength: number): Observable<ICharacter[]> {
      return this.http.get<ICharacter[]>(this.characterUrl+"?page="+pageIdx+"&pageSize="+pageLength);
    }
    ...
    // getCharacter(name: string, pageIdx: number, pageLength: number): Observable<ICharacter | undefined> {
    //     return this.getCharactersFromServer(pageIdx, pageLength)
    //     .pipe(
